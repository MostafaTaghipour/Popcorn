...
import { AlertConfiguration, ConfirmConfiguration } from "@app/types/message";

/* #region  Alert */
/**
 * show native alert according current platform
 *
 * @param {AlertConfiguration} config
 */
...
/* #reg/**
 * show native confirm according current platform
 *
 * @param {ConfirmConfiguration} config
 */
